...
export const getColumns = (handleTransferFunds) => [
  { field: "stripe_id", headerName: "Transaction ID", width: 430 },
  {
    field: "country",
    headerName: "Country",
    width: 250,
  ...
  },
  {
    ...
    renderCell: (params) => {
      ...
      return (
        ...
        >
          {text == "Unsent" ? "Pending" : "Transferred"}
        </div>
      );
    },
  },
    ...
    renderCell: (params) => (
      <ActionContainer>
        ...
        {params.row.status == "succeeded" && (
          <ActionButton
            title={"TransferFunds"}
            handleClick={() => handleTransferFunds(params.row)}
          />
        )}
      </ActionContainer>
    ),
